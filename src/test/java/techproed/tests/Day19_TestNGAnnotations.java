...
public class Day19_TestNGAnnotations {
    ...
    -------------------------------------------------------
    @Ignore// TEST CASE LERI ATLAMAK ICIN KULLANIRIZ
     (enabled = false)// silmeye kiyamiyorum ama calisinca da gic bir seye yaramiyorsa..
     -----------------------------------------------------------
     test NG de test case ler isim sirasina gore calisir
    ...
    @Test @Ignore// TEST CASE LERI ATLAMAK ICIN KULLANIRIZ
    public void test2() {
